...
import at.tuwien.ac.graph.ops.dao.SeparationMinMaxCompDao;
 ...
 */
public class SeparationReport extends Report {
    Logger logger = LoggerFactory.getLogger(SeparationReport.class);
    ...
    private String getComponentsStringOf(SeparationMinimumMaxComponentExpriment expriment, Instance instance) {
    ...
    public static void main(String[] args) {
        new SeparationReport().generateReportIntoFile("separation.tex");

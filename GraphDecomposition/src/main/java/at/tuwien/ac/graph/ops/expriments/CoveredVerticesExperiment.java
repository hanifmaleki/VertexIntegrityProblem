 ...
 */
@Entity
public class CoveredVerticesExperiment extends SimpleExpriment implements Comparable<CoveredVerticesExperiment>{
    private Integer c ;
    ...
    @Override
    public int compareTo(CoveredVerticesExperiment o) {
        if(c!=o.c)

 ...
 */
@Entity
public class FVDSymetryExperiment extends SimpleExpriment implements Comparable<FVDSymetryExperiment>{
    ...
    @OneToMany(mappedBy="expriment", cascade= CascadeType.MERGE)
    ...
    @Override
    public int compareTo(FVDSymetryExperiment o) {
        if(c!=o.c)
